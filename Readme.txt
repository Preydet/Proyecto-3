...
🎯 OBJETIVO:
Desarrollar una interfaz básica de un sitio web de tecnología ("TecnoShop") que responda al siguiente requerimiento:

"Realizar un prototipado simple, en papel o utilizando un programa de dibujo, sobre cómo trabajarás tu sitio. Podrías utilizar draw.io si quieres evaluar una herramienta gratuita, fácil y confiable. 
Muestra de los mensajes de negocio, breve catálogo de productos, e incluir las siguientes secciones:
a. Header
b. Main
c. Products
d. Footer
